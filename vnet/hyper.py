...
hp  = {
	...
	'loss_L1' : 0., # weight regularization
	'loss_L2' : 0., # weight regularization
	...
	'sensory_efficient': True, # make the prior flat in the sensory space
	'stim_p': par['stim_p'],  # for efficient coding;
