...
im = plt.imshow(w_in, vmin=0, vmax=MaxVal1)
plt.title('w_in')
...
plt.title('b_out')
plt.savefig(savedir + '/TrainingSummary_weight_nIter' + str(iteration) + '.png', bbox_inches='tight')
...
plt.grid()
plt.savefig(savedir + '/TrainingSummary_loss_Iter' + str(iteration) + '.png', bbox_inches='tight')
...
for i in range(30):
    ...
    plt.savefig(savedir + '/estimation/Iter' + str(iteration) + '/' + str(i) + '.png', bbox_inches='tight')
plt.show()