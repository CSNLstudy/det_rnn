...
#
# tf.saved_model.save(model, "/Users/hyunwoo/Desktop/2/")
...
for i_model in range(10):
    while iter < N_max:
        ...
        perf_vec = np.array(model_performance['perf'])[indx_recent]
        ...
        if (np.mean(perf_vec) > perf_crit) & (len(perf_vec) >= recency):
            ...
            os.makedirs("/Users/hyunwoo/Desktop/" + str(i_model), exist_ok=True)
            tf.saved_model.save(model, "/Users/hyunwoo/Desktop/" + str(i_model))
