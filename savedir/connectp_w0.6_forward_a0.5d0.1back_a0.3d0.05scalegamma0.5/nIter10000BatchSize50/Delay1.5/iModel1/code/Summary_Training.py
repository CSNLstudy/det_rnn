...
scale_gamma         = 0.5
n_hidden            = 150
connect_p_within    = 0.7
connect_p_adjacent  = 0.3
connect_p_distant   = 0.1
...
par['connect_prob_adjacent_module'] = connect_p_adjacent
par['connect_prob_distant_module'] = connect_p_distant
...
savedir = os.path.dirname(os.path.realpath(__file__)) + \
          '/savedir/connectprob_within' + str(connect_p_within) + '_adjacent' + str(
    connect_p_adjacent) + '_distant' + str(connect_p_distant) + 'scalegamma' + str(scale_gamma) + \
