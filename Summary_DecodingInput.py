...
plt.grid()
plt.savefig(savedir + svmdir + '/Accuracy_input' + str(iteration_load) + '.png', bbox_inches='tight')
...
plt.ylabel('classification accuracy')
plt.grid()
plt.savefig(savedir + svmdir + '/Accuracy_hidden' + str(iteration_load) + '.png', bbox_inches='tight')
...
plt.ylabel('classification accuracy')
plt.grid()
plt.savefig(savedir + svmdir + '/Accuracy_output' + str(iteration_load) + '.png', bbox_inches='tight')
...
plt.colorbar()
plt.savefig(savedir + svmdir + '/Accuracy_input_matrix' + str(iteration_load) + '.png', bbox_inches='tight')
...
plt.ylim([0, par['n_timesteps']])
plt.colorbar()
plt.savefig(savedir + svmdir + '/Accuracy_hidden_matrix' + str(iteration_load) + '.png', bbox_inches='tight')
...
plt.ylim([0, par['n_timesteps']])
plt.colorbar()
plt.savefig(savedir + svmdir + '/Accuracy_output_matrix' + str(iteration_load) + '.png', bbox_inches='tight')
...
plt.xlabel('time point')
plt.ylabel('classification accuracy')
plt.savefig(savedir + svmdir + '/Accuracy_syn_input' + str(iteration_load) + '.png', bbox_inches='tight')
...
plt.xlabel('time point')
plt.ylabel('classification accuracy')
plt.savefig(savedir + svmdir + '/Accuracy_syn_hidden' + str(iteration_load) + '.png', bbox_inches='tight')
...
plt.xlabel('time point')
plt.ylabel('classification accuracy')
plt.savefig(savedir + svmdir + '/Accuracy_syn_output' + str(iteration_load) + '.png', bbox_inches='tight')
...
plt.ylim([0, par['n_timesteps']])
plt.colorbar()
plt.savefig(savedir + svmdir + '/Accuracy_syn_input_matrix' + str(iteration_load) + '.png', bbox_inches='tight')
...
plt.ylim([0, par['n_timesteps']])
plt.colorbar()
plt.savefig(savedir + svmdir + '/Accuracy_syn_hidden_matrix' + str(iteration_load) + '.png', bbox_inches='tight')
...
plt.ylim([0, par['n_timesteps']])
plt.colorbar()
plt.savefig(savedir + svmdir + '/Accuracy_syn_output_matrix' + str(iteration_load) + '.png', bbox_inches='tight')
