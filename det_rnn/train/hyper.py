...
hp  = {
	...
	'w_rnnrr' : w_design('w_rnnrr', par),
	# 'w_char'  : w_design('w_char', par),
...
def update_hp(hp):
	hp.update({		
		# 'w_char0'   : initialize(int(par['n_hidden1']/2),   gain=hp['gain']),
		'w_in10'    : initialize((par['n_input'],   par['n_hiddenr']),   gain=hp['gain']),
		...
		# 'w_rule10'  : initialize((2, par['n_hidden1']), gain=hp['gain']),
		# 'w_rule20'  : initialize((2, par['n_hidden2']), gain=hp['gain']), 
		'w_rnnrr0'  : initialize((par['n_hiddenr'], par['n_hiddenr']),   gain=hp['gain']),
		'w_rnn1r0'  : initialize((par['n_hidden1'], par['n_hiddenr']),   gain=hp['gain']),
		'w_rnnr10'  : initialize((par['n_hiddenr'], par['n_hidden1']),   gain=hp['gain']),
		'w_rnn2r0'  : initialize((par['n_hidden2'], par['n_hiddenr']),   gain=hp['gain']),
		'w_rnnr20'  : initialize((par['n_hiddenr'], par['n_hidden2']),   gain=hp['gain']),
	})
